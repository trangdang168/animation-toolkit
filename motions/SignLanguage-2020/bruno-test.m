...
I = imread('images/p01_INTRODUCTION/0.png');
imshow(I)
hold on
...
plot(leftShoulder(1,:),leftShoulder(2,:),'b','LineWidth',2)
plot(rightShoulder(1,:),rightShoulder(2,:),'b','LineWidth',2)
plot(leftBiceps(1,:),leftBiceps(2,:),'b','LineWidth',2)
plot(rightBiceps(1,:),rightBiceps(2,:),'b','LineWidth',2)
plot(leftForearm(1,:),leftForearm(2,:),'b','LineWidth',2)
plot(rightForearm(1,:),rightForearm(2,:),'b','LineWidth',2)
plot(Hand1Left(1,:),Hand1Left(2,:),'b','LineWidth',2)
plot(Hand1Right(1,:),Hand1Right(2,:),'b','LineWidth',2)

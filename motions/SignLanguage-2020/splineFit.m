function [] splinefit(inputFile, outputFile):
  ...
  numFrames = size(M, 1);
  ht 0 0.42402 0.8 0.339216
  numJointsXYZ = size(M, 2); # 51 = numJoints * 3
  plot(1:windowSize, M(1:windowSize,1)); 
  
  b = linspace(1, windowSize, floor(numFrames/8));
  x = 1:windowSize;
  ...
  spb = ppval(sp,b);
  plot(1:windowSize, M(1:windowSize,1), 'g', xplot,yplot,'b',x,y,'ro',b,spb,'ks');
